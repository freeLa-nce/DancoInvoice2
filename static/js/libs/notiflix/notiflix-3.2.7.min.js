...
(function (t, e) {
  ...
  function (t) {
    ...
    var e,
      ...
      d = { Show: "Show", Ask: "Ask", Prompt: "Prompt" },
      f = {
          ...
          var n = function (a) {
            for (var n in a)
              Object.prototype.hasOwnProperty.call(a, n) &&
                (t[n] =
                  e &&
                  "[object Object]" === Object.prototype.toString.call(a[n])
                    ? v(t[n], a[n])
                    : a[n]);
          };
          a < arguments.length;
      ...
      E = function (a, n, o, s) {
        ...
        if (
          ...
          var p = {};
          "object" == typeof o ? (p = o) : "object" == typeof s && (p = s),
            (e = v(!0, e, p));
        }
        ...
        if (
          ...
          (x.id = c.overlayID),
            ...
            (x.style.right = 0),
            (x.style.bottom = 0),
            (x.style.background = d.backOverlayColor || e.backOverlayColor),
        ...
        (g.id = e.ID + "-" + F),
          ...
          (g.style.color = d.textColor),
          (g.style.background = d.background),
          (g.style.borderRadius = e.borderRadius),
          (g.style.pointerEvents = "all"),
          e.rtl && (g.setAttribute("dir", "rtl"), g.classList.add("nx-rtl-on")),
          (g.style.fontFamily = '"' + e.fontFamily + '", ' + r),
          e.cssAnimation &&
        ...
        if (h) {
          var w,
            ...
            z = function () {
              ...
              e && 0 >= f.childElementCount && e.classList.add("nx-remove"),
                clearTimeout(w);
            },
            S = function () {
              if (
                (h && null !== h.parentNode && h.parentNode.removeChild(h),
                0 >= f.childElementCount && null !== f.parentNode)
              ) {
        ...
        if (e.showOnlyTheLastOne && 0 < F)
          for (
            var A,
              M = t.document.querySelectorAll(
                "[id^=" + e.ID + "-]:not([id=" + e.ID + "-" + F + "])"
              ),
              X = 0;
            X < M.length;
            X++
          )
            (A = M[X]), null !== A.parentNode && A.parentNode.removeChild(A);
        e = v(!0, e, m);
      },
      O = function () {
        return null;
      ...
      H = function (e, n, i, o, s, l) {
        ...
        if (
          ...
          var d = {};
          "object" == typeof s ? (d = s) : "object" == typeof l && (d = l),
            (c = v(!0, a, {})),
            (a = v(!0, a, d));
        }
        ...
        "string" != typeof n && (n = "Notiflix " + e),
          ...
          n.length > a.titleMaxLength &&
            (n = n.substring(0, a.titleMaxLength) + "..."),
          i.length > a.messageMaxLength &&
            (i = i.substring(0, a.messageMaxLength) + "..."),
          o.length > a.buttonMaxLength &&
            (o = o.substring(0, a.buttonMaxLength) + "..."),
          a.cssAnimation || (a.cssAnimationDuration = 0);
        var x = t.document.createElement("div");
        (x.id = p.ID),
          (x.className = a.className),
          (x.style.zIndex = a.zindex),
          (x.style.borderRadius = a.borderRadius),
          (x.style.fontFamily = '"' + a.fontFamily + '", ' + r),
        ...
        a.backOverlay &&
          (g =
            ...
            (u ? " nx-report-click-to-close" : "") +
            '" style="background:' +
            (f.backOverlayColor || a.backOverlayColor) +
            ";animation-duration:" +
        ...
        if (
          (e === m.Success
            ? (b = C(a.svgSize, f.svgColor))
            : e === m.Failure
            ? (b = z(a.svgSize, f.svgColor))
            : e === m.Warning
            ? (b = S(a.svgSize, f.svgColor))
            : e === m.Info && (b = L(a.svgSize, f.svgColor)),
          (x.innerHTML =
            g +
            '<div class="' +
            a.className +
      ...
      j = function (e, a, i, o, s, l, c, m, p) {
        ...
        n || G.Confirm.init({});
        var x = v(!0, n, {});
        "object" != typeof p || Array.isArray(p) || (n = v(!0, n, p)),
          "string" != typeof a && (a = "Notiflix Confirm"),
          "string" != typeof i && (i = "Do you agree with me?"),
          "string" != typeof s && (s = "Yes"),
          "string" != typeof l && (l = "No"),
          "function" != typeof c && (c = void 0),
          "function" != typeof m && (m = void 0),
          n.plainText && ((a = N(a)), (i = N(i)), (s = N(s)), (l = N(l))),
          n.plainText ||
            (a.length > n.titleMaxLength &&
            ...
            i.length > n.messageMaxLength &&
              ...
              (s = "Okay"),
              (l = "...")),
            (s.length || l.length) > n.buttonsMaxLength &&
              ((a = "Possible HTML Tags Error"),
              (i =
              ...
              (l = "..."))),
          a.length > n.titleMaxLength &&
            (a = a.substring(0, n.titleMaxLength) + "..."),
          i.length > n.messageMaxLength &&
            (i = i.substring(0, n.messageMaxLength) + "..."),
          s.length > n.buttonsMaxLength &&
            (s = s.substring(0, n.buttonsMaxLength) + "..."),
        ...
        (g.id = f.ID),
          (g.className =
            ...
            (n.cssAnimation
              ...
              : "")),
          (g.style.zIndex = n.zindex),
          (g.style.padding = n.distance),
          n.rtl && (g.setAttribute("dir", "rtl"), g.classList.add("nx-rtl-on"));
        var u = "string" == typeof n.position ? n.position.trim() : "center";
        g.classList.add("nx-position-" + u),
          (g.style.fontFamily = '"' + n.fontFamily + '", ' + r);
        var b = "";
        n.backOverlay &&
          (b =
            '<div class="' +
        ...
        if (
          ...
          var L = t.document.getElementById(g.id),
            I = t.document.getElementById("NXConfirmButtonOk"),
          ...
          if (
            ...
            I.addEventListener("click", function (t) {
              ...
              "function" == typeof c &&
                (e === d.Prompt && A && (C = A.value || ""), c(C)),
                L.classList.add("nx-remove");
              var i = setTimeout(function () {
                null !== L.parentNode &&
                  (L.parentNode.removeChild(L), clearTimeout(i));
              }, n.cssAnimationDuration);
            }),
            "function" == typeof c)
          ) {
      ...
      V = function (e, a, n, o, s) {
        ...
        if (
          ...
          var c = {};
          "object" == typeof a ? (c = a) : "object" == typeof n && (c = n),
            (i = v(!0, i, c));
        }
        var m = "";
        if (("string" == typeof a && 0 < a.length && (m = a), o)) {
          m =
            m.length > i.messageMaxLength
          ...
          var f = parseInt((i.svgSize || "").replace(/[^0-9]/g, "")),
            u = t.innerWidth,
            b = f >= u ? u - 40 + "px" : f + "px",
            h =
              '<div style="width:' +
          ...
          if (
            ...
            (w.style.animationDuration = i.cssAnimationDuration + "ms"),
            (w.style.fontFamily = '"' + i.fontFamily + '", ' + r),
            ...
            i.rtl &&
              (w.setAttribute("dir", "rtl"), w.classList.add("nx-rtl-on")),
            (w.innerHTML = h + p),
            !t.document.getElementById(w.id) &&
              (t.document.body.appendChild(w), i.clickToClose))
          ) {
            ...
            C.addEventListener("click", function () {
              ...
              var t = setTimeout(function () {
                null !== w.parentNode &&
                  (w.parentNode.removeChild(w), clearTimeout(t));
      ...
      Q = function (e, a, n, i, s, l) {
        ...
        if (
          ...
          var f = {};
          "object" == typeof i ? (f = i) : "object" == typeof s && (f = s),
            (o = v(!0, o, f));
        }
        var x = "";
        "string" == typeof i && 0 < i.length && (x = i),
          ...
          for (
            ...
            if (((S = c[D]), S)) {
              ...
              if (1 > T.length) {
                ...
                a &&
                  (a === u.Hourglass
                    ? (F = A(o.svgSize, o.svgColor))
                    : a === u.Circle
                    ? (F = M(o.svgSize, o.svgColor))
                    : a === u.Arrows
                    ? (F = X(o.svgSize, o.svgColor))
                    : a === u.Dots
                    ? (F = R(o.svgSize, o.svgColor))
                    : a === u.Pulse
                    ? (F = B(o.svgSize, o.svgColor))
                    : (F = I(o.svgSize, o.svgColor)));
                var E =
                    '<span class="' +
                    g +
                    '-icon" style="width:' +
                ...
                (H.id = b.ID + "-" + U),
                  ...
                  (H.style.position = o.position),
                  (H.style.zIndex = o.zindex),
                  (H.style.background = o.backgroundColor),
                  (H.style.animationDuration = o.cssAnimationDuration + "ms"),
                  (H.style.fontFamily = '"' + o.fontFamily + '", ' + r),
                  ...
                  (H.innerHTML = E + O);
                var W = t.getComputedStyle(S).getPropertyValue("position"),
                  j =
                    "string" == typeof W
                ...
                var Q = "",
                  K =
                    -1 >=
                    ["absolute", "relative", "fixed", "sticky"].indexOf(j);
                if (K || 0 < q.length) {
                  if (!k("head")) return !1;
            ...
            tt = function (t) {
              if (t && 0 < t.length)
                for (var e, a = 0; a < t.length; a++)
                  (e = t[a]), e && (e.classList.add("nx-remove"), _(e));
              else
                "string" == typeof n
                  ? h(
